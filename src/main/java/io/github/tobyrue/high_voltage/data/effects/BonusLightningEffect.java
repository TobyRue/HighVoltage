...
public record BonusLightningEffect(int radius, int chance) implements WeatherProfile.WeatherEffect {
    public static final Codec<BonusLightningEffect> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.INT.fieldOf("radius").forGetter(BonusLightningEffect::radius),
